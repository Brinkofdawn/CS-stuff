...
for (int i = 0; i < TURNS; i++){
    ...
    if(checkwin()== 20){ // cheking if Team 2 has won the game
        printf("Final Board \n");
        printboard();
         printf("Team 2 has won at turn %d \n", i);
        i= i +TURNS;}

    else if(checkwin()== 10){ // checking if Team 1 has won the game
        printf("Final Board \n");
        printboard();
        printf("Team 1 has won at turn %d \n", i);
        i= i +TURNS;
}
        ...
        printf("%d player(s) on Team 1 survived \n", countleft(team1));
         printf("%d player(s) on Team 2 survived \n",countleft(team2));
...
{randomspot(i, team1);
    i++; // incrementing player id for next team
randomspot(i,team2);}
}
...
void printboard(){
    ...
    printf("%3c", pieces[board[columns][rows].type]);
    }
    else{
        printf("%3d",board[columns][rows].id);
    }
