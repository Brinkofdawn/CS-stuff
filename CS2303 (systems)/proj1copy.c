...
for (int i = 0; i < r; i++){ // creates a line of =, length equal to the value of r
	printf("=");
}
printf("\n");
...
int main(){
	...
	scanf("%d",&pairs);
	for(int i=0;pairs>i;i++){ // asks for the sets of coordinate pairs and accumalates distance value
		int x1,x2,y1,y2;
		printf("\n Set %d \n",i+1);
